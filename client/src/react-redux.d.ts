// NOTE(louis): This file is copied from @types/react-redux@5.0.12
// with modification to make it typecheck with TypeScript >= 2.8
// TypeScript >= 2.8 has Exclude which allows us
// to implement Omit without type error.
...
declare module 'react-redux' {
  ...
  // NOTE(louis): Here is the magic, we alias Diff to Exclude
